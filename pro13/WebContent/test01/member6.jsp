...
%>    
<jsp:useBean id="m" class="sec02.MemberBean"	/>
<jsp:setProperty  name="m" property="*" />
<jsp:useBean   id="addr" class="sec02.Address"/>
...
<%
  m.setAddr(addr);//MemberBean의 addr 속성에 Address 빈을 설정합니다.
%> 
<html>
<head>
<meta charset=”UTF-8">
...
<td width="5%" ><b>도시</b></td>
   ...
   <tr align="center">
		...
		<td>${m.name} </td>
		<td>${m.email}</td>
      <%--2.자바 빈의 속성 이름과 마침표 연산자를 이용해 주소를 출력합니다. --%>
		<td>${m.addr.city}</td>
